  ...
  return (
    ...
    >
      ...
      <div className="text-slate-700 dark:text-slate-200 space-y-5 text-lg leading-relaxed">
        <p>
          Existem várias formas de trabalhar por projetos. Sugerimos projetos com diversas durações, de acordo com a faixa etária, como fator de mobilização para engajar os estudantes. 
        </p>
        <p>
