...
const etapas = [
  {
    ...
    pagina: "Educador, páginas 18 a 33",
  },
  {
    numero: 2,
    ...
    pagina: "Educador, páginas 34 a 42",
  },
  {
    numero: 3,
    ...
    pagina: "Educador, páginas 43 a 47",
    foto: "/projeto.webp",
  },
  {
    numero: 4,
    ...
    pagina: "Educador, a partir da página 48",
  },
];
  ...
  return (
    <div className="space-y-8">
      <div className={`rounded-2xl border ${t.borderOpen} ${t.bgSoft} p-4 md:p-5`}>
        ...
        <span className={`mt-3 inline-block rounded-full px-2.5 py-1 text-xs font-medium ${t.chip}`}>
          Educador, página 29
        </span>
      </div>
