...
const navigation = {
  ...
  'Projetos': {
    ...
    components: [
      ...
      { id: 'projeto-1', title: '1º Ano' },
      { id: 'projeto-2', title: '2º Ano' },
      { id: 'projeto-3', title: '3º Ano' },
  ...
  'Matriz de Habilidades': {
    ...
    components: [
      ...
      { id: 'matriz-1', title: '1º Ano' },
      { id: 'matriz-2', title: '2º Ano' },
      { id: 'matriz-3', title: '3º Ano' },
      { id: 'matriz-4', title: '4º Ano' },
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={isOpen ? 'Fechar menu de conteúdo' : 'Abrir menu de conteúdo'}
